function [matchedTrodes] = matchTrodes(centroidCoords,trodeNames)
% MATCHTRODES matches localized electrodes with contact names. 
%   


% you could query the user if you don't want to use this as a function. or
...
text(C(:,1),C(:,2),trodeNames)
hold off
title('Are these clusters correct? [Y/n]','fontsize',16)
corFlag = input('Are these clusters correct? [Y/n]','s');

if strcmp(corFlag,'Y')
    % this is where the manual step of identifying each electrode can go? 
    
    
elseif strcmp(corFlag,'n')
